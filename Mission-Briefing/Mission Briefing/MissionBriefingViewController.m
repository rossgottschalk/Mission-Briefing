...
- (IBAction)authenticateAgent:(UIButton *)sender
{
    ...
    //
    if (self.agentNameTextField.text.length != 0 && self.agentPasswordTextField.text != 0)
    {
        //
        ...
        UIColor *authenticatedBackgroundColor =[UIColor colorWithRed:.585 green:.78 blue:.188 alpha:1];
    ...
    else
    {
        ...
        //    Once you have the color object, you should be able to set the view's background color to this object.
        //
        UIColor *accessDeniedBackgroundColor = [UIColor colorWithRed:.78 green:.188 blue:.188 alpha:1];
        // Additional step to set the above color object to self.view's background color
